 ...
 */
include_once "gg/base.php";
session_start();

require_once 'gg/Google/Client.php';
require_once 'gg/Google/Service/YouTube.php';
require_once 'gg/Google/Service/Drive.php';
 ...
 ************************************************/
 $client_id = '644082817262-vd6s6328q3116bpk9oq2v2rel0kpo4qp.apps.googleusercontent.com';
 $client_secret = 'notasecret';
 $redirect_uri = 'http://dailycup.skeletopedia.sk/test';
